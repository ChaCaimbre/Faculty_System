...
echo "CISCO (CON 102) Sched Count: " . (isset($grouped['CISCO (CON 102)']) ? count($grouped['CISCO (CON 102)']) : 0) . "\n";
echo "OTHER ROOMS Sched Count: " . (isset($grouped['OTHER ROOMS']) ? count($grouped['OTHER ROOMS']) : 0) . "\n";
?>

...
addSched($db, $roomMap, 'COMLAB1', $monThu, '14:30:00', '16:00:00', 'IT-115L', 'AI25', 'DURANGO'); // Fixed AI22 -> AI25
...
// COMLAB2
addSched($db, $roomMap, 'COMLAB2', $monThu, '07:30:00', '09:00:00', 'IT-107', 'AI31', 'GALBAN');
addSched($db, $roomMap, 'COMLAB2', $monThu, '09:00:00', '10:30:00', 'IT-107L', 'AI13', 'GALBAN'); // Fixed AI31 -> AI13
...
addSched($db, $roomMap, 'COMLAB2', $monThu, '16:00:00', '17:30:00', 'IT-107', 'AI14', 'GALBAN');
...
addSched($db, $roomMap, 'COMLAB2', $wedOnly, '15:00:00', '17:00:00', 'IT-127', 'AI33', 'LAGONOY');
addSched($db, $roomMap, 'COMLAB2', $wedOnly, '17:00:00', '19:00:00', 'IT-127', 'AI31', 'CELESTIAL');

addSched($db, $roomMap, 'COMLAB2', $satOnly, '10:00:00', '12:00:00', 'IT-129', 'AI35', 'DIAZ');

// COMLAB3
addSched($db, $roomMap, 'COMLAB3', $monThu, '07:30:00', '09:00:00', 'IT-128', 'AI31', 'FUNCION');
...
addSched($db, $roomMap, 'COMLAB3', $monThu, '14:30:00', '16:00:00', 'IT-105', 'AI32', 'CABANGON');
...
addSched($db, $roomMap, 'COMLAB3', $tueFri, '13:00:00', '14:30:00', 'IT-108', 'AI15', 'ORMENETA');
addSched($db, $roomMap, 'COMLAB3', $tueFri, '14:30:00', '16:00:00', 'IT-108', 'AI15', 'ORMENETA');
addSched($db, $roomMap, 'COMLAB3', $tueFri, '16:00:00', '17:30:00', 'IT-115L', 'AI23', 'FERNANDEZ');

addSched($db, $roomMap, 'COMLAB3', $wedOnly, '08:00:00', '10:00:00', 'IT-108', 'AI31', 'CINCO');
...
addSched($db, $roomMap, 'COMLAB3', $wedOnly, '15:00:00', '17:00:00', 'IT-129', 'AI33', 'DABLEO');
...
addSched($db, $roomMap, 'COMLAB4', $monThu, '16:00:00', '17:30:00', 'IT-120L', 'AI21', 'DALAN');

addSched($db, $roomMap, 'COMLAB4', $tueFri, '07:30:00', '09:00:00', 'IT-120', 'AI24', 'TIBE');
addSched($db, $roomMap, 'COMLAB4', $tueFri, '09:00:00', '10:30:00', 'IT-112L', 'AI24', 'TIBE');
addSched($db, $roomMap, 'COMLAB4', $tueFri, '10:30:00', '12:00:00', 'GE-113', 'AS22', 'GALBAN');
addSched($db, $roomMap, 'COMLAB4', $tueFri, '13:00:00', '14:30:00', 'IT-108L', 'AI22', 'TIBE');
addSched($db, $roomMap, 'COMLAB4', $tueFri, '14:30:00', '16:00:00', 'IT-120', 'AI22', 'TIBE');
addSched($db, $roomMap, 'COMLAB4', $tueFri, '16:00:00', '17:30:00', 'IT-108', 'AI12', 'ORMENETA');
...
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $monThu, '13:00:00', '14:30:00', 'SPT-104', 'AL21', 'NAVARRO'); // Fixed APOLINAR/AI21 -> NAVARRO/AL21
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $monThu, '14:30:00', '16:00:00', 'IT-129L', 'AI31', 'TIBE');
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $monThu, '16:00:00', '17:30:00', 'IT-126', 'AI32', 'TIBE');
...
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $tueFri, '09:00:00', '10:30:00', 'IT-128L', 'AI35', 'AMAGO');
...
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $wedOnly, '10:00:00', '12:00:00', 'LIS-112', 'AL31', 'NAVARRO');
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $wedOnly, '15:00:00', '17:00:00', 'GE-107', 'AL21', 'NAVARRO');
addSched($db, $roomMap, 'COMLAB5 (CON 103)', $wedOnly, '17:00:00', '19:00:00', 'TOUR-101', 'MT12', 'ALMENARIO');

addSched($db, $roomMap, 'COMLAB5 (CON 103)', $satOnly, '08:00:00', '10:00:00', 'LIS-104', 'AL21', 'SASI');
...
addSched($db, $roomMap, 'COMLAB6 (CON 104)', $tueFri, '14:30:00', '16:00:00', 'IT-120', 'AI23', 'DALAN');
...
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $monThu, '10:30:00', '12:00:00', 'IT-120', 'AI25', 'TIBE');
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $monThu, '13:00:00', '16:00:00', 'IT-134', 'AI42', 'CINCO');

addSched($db, $roomMap, 'COMLAB7 (CON 105)', $tueFri, '07:30:00', '11:00:00', 'IT-124', 'AI32', 'CALUZA'); // Image shows 7:30-10:30 for IT-124/AI32/CALUZA in COMLAB7 Tue/Fri? Ah, image shows 7:30-9:00 and 9:00-10:30? No, wait. 
// Let's re-read COMLAB7 Tue/Fri:
...
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $tueFri, '10:30:00', '12:00:00', 'LIS ICT-104 A/L', '', '');
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $tueFri, '14:30:00', '16:00:00', 'TOUR-101L', 'MT11', 'SAMPAYAN');
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $tueFri, '16:00:00', '17:30:00', 'TOUR-101', 'MT11', 'SAMPAYAN');
addSched($db, $roomMap, 'COMLAB7 (CON 105)', $tueFri, '17:30:00', '19:00:00', 'GE-113', 'SM32', 'MORETO');
